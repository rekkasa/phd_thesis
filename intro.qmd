...
[**REF**](https://doi.org/10.1007/s00198-019-05176-3).
...
[**REF**](https://heart.bmj.com/content/98/9/683), are important empirical tools
for the assessment of a patient’s baseline risk. For example, the Systematic
...
the individual level across the population
...
patients can benefit much more. Consequently, baseline risk can be used as a
subgrouping variable for assessing HTE. For many populations of patients for
...
subgroups [refs]. If no such models exist, the researcher can develop one in the
dataset that is used for treatment effect estimation (**REFS**).

Baseline risk can also be used directly for predicting individual treatment
benefit [**REF**: Califf; Dahabreh, IJE 2016]. For example Califf et al
(**REF**) predicted individual benefits regarding 30-day mortality with tissue
plasminogen activator (tPA) compared to streptokinase treatment in patients with
acute myocardial infarction using baseline mortality risk and assuming a
constant relative tPA treatment effect. However, relative treatment effect does
not need to be constant. Modeling more flexible interactions of treatment with
baseline outcome risk may provide more accurate absolute benefit predictions for
individual patients.
...
[**REF**](http://dx.doi.org/10.1016/j.jclinepi.2013.11.003). Therefore, in the
presence of a truly effective treatment, effect heterogeneity should always be
anticipated on some scale [**REF**: Dahabreh, IJE 2016], as baseline risk is
...
aforementioned conditions are not met [**REF**: Balan, JCE].
...
In **@sec-review** we present the results of a scoping literature review
of regression modeling approaches for the assessment of treatment effect
heterogeneity in the clinical trial setting. In **@sec-framework** we
develop a standardized scalable framework for the assessment of treatment effect
...
of Cancer centers. In **@sec-covid** we develop and temporally validate
a model for the prediction of 28-day mortality and admission to the ICU for
...
**@sec-osteoporosis** we apply the standardized framework developed in
**@sec-framework** to evaluate effect heterogeneity of teripatide treatment
compared to oral bisphosphonates in female patients above the age of 50 with
established osteoporosis. Finally, in Chapter 8 we present a general discussion
along with perspectives on future work.
