...
assessment of a patient's baseline risk. Adequate evaluation of a prediction
model's performance in new patients is crucial. In most cases, this mainly
focuses on the prediction model's discriminative performance, i.e. its ability
to separate lower from higher risk patients, and its calibration, i.e. the
...
insight into the added value of using these models for medical decision
