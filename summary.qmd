...
and, consequently, individualizing treatment decisions. To this end we develop
risk prediction models for several outcomes of interest in the fields of cancer
...
of methods research in recent years. To this end we systematically review the
literature on predictive approaches for the evaluation of treatment effect
heterogeneity. In addition, we develop methods for risk-based assessment of
treatment effect heterogeneity, capitalizing on the strong relationship between
...
In @sec-melanoma we develop prediction models for recurrence, distant metastasis
and overall mortality to be used for the management of patients with sentinel
node-positive melanoma. For model development we use data of patients from nine
European Organization for Research and Treatment of Cancer centers. We use Cox
regression analysis for the prediction of all outcomes of interest. We
externally validate in a prospective cohort sentinel node-positive melanoma
patients, showing consistency of results. Finally, we develop a nomogram for
...
intensive care unit we recalibrate the mortality prediction model including a
