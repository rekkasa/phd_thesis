...
\blfootnote{Chapter based on \textit{Rekkas A, van Klaveren D, Ryan PB et al. A standardized framework for risk-based assessment of treatment effect heterogeneity in observational healthcare databases. npj Digit. Med. 6, 58 (2023). https://doi.org/10.1038/s41746-023-00794-y}}
...
```{r fig-framework, cache=FALSE, echo=FALSE, fig.cap="Illustration of the framework’s application on two observational databases, preferably mapped to OMOP-CDM."}
...
Supplementary Results, Section D of the 
[online Supplement](https://www.nature.com/articles/s41746-023-00794-y).
Our analyses included a total of 355,826 (CCAE), 54,835 (MDCD), and 37,882
(MDCR) patients initiating treatment with thiazide or thiazide-like diuretics
and 930,629 (CCAE), 106,492 (MDCD), and 105,852 (MDCR) patients initiating
treatment with ACE inhibitors (Table \ref{table:ch3-patients}). Patient
characteristics are available in Table A.1 of [Appendix
@sec-framework-appendix]. Adequate numbers of patients were included in all
strata of predicted acute MI risk (Table A.2 of [Appendix
...
Table 24 of the
[online Supplement](https://www.nature.com/articles/s41746-023-00794-y)
we show the available sample sizes on which the prediction models were
developed, while in Supplementary Tables 25-27 of the
[online Supplement](https://www.nature.com/articles/s41746-023-00794-y)
we show the 20 selected covariates with the largest coefficients in each
database.
...
of 76 negative control outcomes (Supplementary Results Section C of the 
[online Supplement](https://www.nature.com/articles/s41746-023-00794-y))
showed no evidence of residual confounding, except for CCAE
...
```{r fig-negativeControls, cache=TRUE, echo=FALSE, fig.cap="Effect size estimates for the negative controls (true hazard ratio = 1) in CCAE, MDCD, and MDCR databases. Estimates below the diagonal dashed lines are statistically significant (different from the true effect size; alpha = 0.05). A well-calibrated estimator should include the true effect size within the 95% confidence interval, 95% of times", fig.show="hold", out.width = '80%'}
...
```{r fig-absoluteResultsSafety, cache=TRUE, echo=FALSE, fig.cap="Absolute treatment effects for safety outcomes. Treatment effect heterogeneity for the safety outcomes on the absolute scale of thiazide or thiazide-like diuretics compared to ACE inhibitors within strata of predicted acute MI risk. RG-1 represents the group of patients with acute MI risk below 1%; RG-2 represents the group of patients with acute MI risk between 1% and 1.5%; RG-3 represents the group of patients with acute MI risk larger than 1.5%. Absolute treatment effects estimated in CCAE, MDCD, and MDCR are represented by blue, green, and orange circles, respectively. The bars represent 95% confidence intervals. Values above 0 favor thiazide or thiazide-like diuretics, while values below 0 favor ACE inhibitors.", fig.show="hold", out.width = '80%',fig.pos="H"}
...
Supplementary material for this chapter is available in [Appendix @sec-framework-appendix]
and online at
[https://www.nature.com/articles/s41746-023-00794-y](https://www.nature.com/articles/s41746-023-00794-y).
