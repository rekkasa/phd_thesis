...
10-year major osteoporotic fracture risk [@kanis2019algorithm].
...
```{r fig-ch7-psDensity, cache=TRUE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallPsDensity_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-balance, cache=TRUE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallCovariateBalance_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-ncPlot, cache=TRUE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallNcPlot_itt_att_1095_custom.tiff")))
```


```{r fig-ch7-metaOverall, cache=TRUE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-plotMetaOverall_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-metaRiskStratified, cache=TRUE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-plotMetaRiskStratified_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-absolute, cache=FALSE, echo=TRUE, fig.cap="test", fig.show="hold", out.width = '100%'}
