# Teriparatide vs bisphosphonates: A treatment effect heterogeneity study {#sec-osteoporosis}
...
```{r fig-ch7-psDensity, cache=TRUE, echo=FALSE, warning=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallPsDensity_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-balance, cache=TRUE, echo=FALSE, warning=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallCovariateBalance_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-ncPlot, cache=TRUE, echo=FALSE,warning=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-overallNcPlot_itt_att_1095_custom.tiff")))
```


```{r fig-ch7-metaOverall, cache=TRUE, echo=FALSE,warning=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-plotMetaOverall_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-metaRiskStratified, cache=TRUE,warning=FALSE, echo=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here::here("figures/ch7-plotMetaRiskStratified_itt_att_1095_custom.tiff")))
```

```{r fig-ch7-absolute, cache=TRUE, echo=FALSE,warning=FALSE, fig.cap="test", fig.show="hold", out.width = '100%'}
