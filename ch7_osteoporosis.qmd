...
users, 280,901 person-years, and 3,409 fractures (Table \ref{table:ch7-populations}).
Before matching, TP users were more likely to have a diagnosis of
osteoarthritis, rheumatoid arthritis, depressive disorder, and gastroesophageal
reflux disease compared to BP users (Supplementary Tables 10-13). After matching,
these imbalances disappeared (Table \ref{table:ch7-table1}).
...
confounding (Supplementary Figure 2).
