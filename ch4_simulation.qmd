...
similar to the base-case scenario (***Supplement, Figure S10***).
...
all methods was more stable (***Supplement, Figure S6***). Finally, when we increased
...
treatment-related harms (***Supplement, Figure S7***).
...
17,000 (***Supplement, Figure S8***) or the true prediction c-statistic to 0.85
(***Supplement, Figure S9***), RCS-3 was somewhat better calibrated than the
