...
\bottomrule
\end{tabular}}
\caption{Characteristics of patients in Optum-EHR receiving teriparatide or bisphosphonates before and after matching on the propensity score (continued).}
\end{table}
