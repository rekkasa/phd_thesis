...
\@ref(review) we reviewed the available literature on predictive approaches to
treatment effect heterogeneity. In chapter \@ref(framework) we presented a
...
inhibitors for the treatment of hypertension (chapter \@ref(framework)). Second,
we evaluated treatment effect heterogeneity of teriparatide compared to oral
bisphosphonates for patients with osteoporosis (chapter \@ref(osteoporosis)). In
chapter \@ref(simulation) we presented risk-based approaches for predicting
individualized treatment effect. Finally, in chapters \@ref(melanoma) and
\@ref(covid) we presented the development and validation of models for
