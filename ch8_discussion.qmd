...
Therefore, our developed prediction model of @sec-covid could be safely applied
to aid medical decision making in the Netherlands during the earlier stages of
the pandemic. However, its generalizability to other healthcare systems needs to
be explored. In addition, evaluation of its temporal validity in subsequent
periods is required and, if found necessary, the model should be updated. Recent
work has shown promising results with the application of a model updating
framework [@levy2022development].
...
bisphsophonates in patients with osteoporosis with regard to three outcomes of
