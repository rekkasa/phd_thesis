...
places may be significantly different compared to the model development
population  – beyond those represented in the prediction model – and disparities
in data capture may also be present. To give insight into its transportability,
we externally validated the EORTC-DeCOG nomgram of chapter @sec-melanoma in data
from Germany and adopted a leave-one-center-out validation approach for the COPE
prediction model of chapter 4 (**REF**: internal-exetrnal paper Ewout).
