...
cells, <0.5 mm, 0.[H].0 mm, >1.0-2.0 mm, >2.0-5.0 mm and >5.0 mm). For the
...
6[H]30 months). In the prospective validation cohort, recurrence at five years
...
population); 25-50% (intermediate risk; score 1[H]5; 52.9% of the population);
50-75% (high risk; score 16-19; 33.2% of the population); and >75% (very high
risk; score 2[H]3; 10.0% of the population). The observed outcomes for
...
extended model for recurrence had a c-index of 0.69 (95% CI: 0.6[H].72). The
calibrated extended models for DM and OM showed c-indices of 0.72 (95% CI:
0.6[H].74) and 0.72 (95% CI: 0.69-0.75), respectively.
...
predicting recurrence, DM and OM were 0.63 (95% CI: 0.6[H].65), 0.64 (95% CI:
0.6[H].67) and 0.64 (95% CI: 0.61-0.67), respectively. The observed outcomes for
recurrence, DM and OM per risk group are shown in Table \ref{table:ch5-table3}.
...
overall model discrim- ination (see Table \ref{table:ch5-table5}), but also
